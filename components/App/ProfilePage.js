...
import { Text, Button, Thumbnail, Tabs, Tab, Icon, Card, CardItem, Left, Right, Body, H2, Spinner, Label} from 'native-base';
...
class Profile extends Component {
    ...
    componentWillMount(){
        searchSingle({link: "users", child: "username", search: this.props.state.username})
        .once("value",function(snapshot){
            this.setState({user: snapshotToArray(snapshot)[0], renderDetails: true})
        }.bind(this))
        ...
        // searchSingle({link: "meals", child: "username", search: this.props.state.username})
        // .once("value",function(snapshot){
        //  this.setState({meals: snapshotToArray(snapshot), renderMeals: true})
        // }.bind(this))
        // await searchMulti({link: "users", child: "username", search: this.props.state.username})
